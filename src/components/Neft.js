                    ...
                    <div className="container">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" name="recipientName" className="form-control" value={this.state.recipientName}
                                    onChange={this.handleChange} validations={[required]} />
                                {this.state.errors.recipientName.length > 0 && 
                                    <span className='error'>{this.state.errors.recipientName}</span>}
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" name="recipientAccountNumber" className="form-control" value={this.state.recipientAccountNumber}
                                    onChange={this.handleChange} validations={[required]} />
                                {this.state.errors.recipientAccountNumber.length > 0 && 
                                    <span className='error'>{this.state.errors.recipientAccountNumber}</span>}
                            </div>
